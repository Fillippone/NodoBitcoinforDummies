...
2. Scrivete l'immagine sel sistema operativo sulla memory card seguendo [questa guida (in inglese)](https://www.raspberrypi.org/documentation/installation/installing-images/README.md)
