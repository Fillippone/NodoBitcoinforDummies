...
* Ancora loggeti come utente Admin, create un link  simbolico al file binario `ip` che si trova nella directory `/bin/ip`, visto che sembra che LND fatichi a trovarlo in qualche caso. 
