...
$ rm *
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.5.1-beta/lnd-linux-armv7-v0.5-beta.tar.gz
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.5.1-beta/manifest-v0.5-beta.txt
$ wget https://github.com/lightningnetwork/lnd/releases/download/v0.5.1-beta/manifest-v0.5-beta.txt.sig
...
![Macaroon](images/40_ls_macaroon.png)
