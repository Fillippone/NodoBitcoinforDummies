...
:point_right: Avete bisogno di maggior informazioni? Cercate ["configurare indirizzo ip statico dhcp"](https://duckduckgo.com/?q=configurare+indirizzo+ip+statico+dhcp&t=h_&ia=web) aggiiungendo alla ricerca il vostro modello di Router. 
