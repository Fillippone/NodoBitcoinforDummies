...
* Mentre aggiornate ,soprattutto se  **aggiornate a LND 0.5**, vi sugggerisco di chiudere i vostri canali prima, visto che ci sono stati parecchi casi di fondi bloccati che hanno richiesto molto lavoro con molte difficoltà per recuperare i fondi.
...
* Cancellate le cose inutuli sull' HD, quindi scaricate, verificate ed installate gli ultimi binari LND.
